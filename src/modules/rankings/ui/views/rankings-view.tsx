...
export const RankingsView = () => {
  ...
  const getRankStyle = (rank: number) => {
    switch (rank) {
      case 1:
        return "bg-gradient-to-br from-yellow-400 via-yellow-300 to-amber-300 dark:from-yellow-500 dark:via-yellow-400 dark:to-amber-400 text-yellow-900 shadow-lg shadow-yellow-500/30 animate-pulse-slow";
      case 2:
        return "bg-gradient-to-br from-gray-200 via-gray-100 to-gray-50 dark:from-gray-700 dark:via-gray-600 dark:to-gray-500 text-gray-800 dark:text-gray-200 shadow-md shadow-gray-400/20";
      case 3:
        return "bg-gradient-to-br from-orange-200 via-orange-100 to-amber-100 dark:from-orange-600 dark:via-orange-500 dark:to-amber-500 text-orange-900 dark:text-orange-100 shadow-md shadow-orange-500/20";
      default:
        return "bg-gradient-to-br from-background to-muted/50 dark:from-muted/20 dark:to-muted/10 border border-border/50";
    }
  };
    ...
    <div className="min-h-screen  bg-gradient-to-b from-background via-background to-muted/5 py-8 px-4">
      <div className="">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
              <div className="flex items-center gap-4">
                <div className="relative">
                  <div className="p-4 bg-gradient-to-br from-amber-500 to-yellow-500 rounded-2xl shadow-2xl shadow-amber-500/20">
        ...
        <div className={`transition-all duration-1000 delay-300`}>
          <div className="relative">
            {/* Glow effect */}
            <div className="absolute inset-0 bg-gradient-to-r from-amber-500/5 via-yellow-500/5 to-amber-500/5 blur-3xl rounded-3xl" />
            
            {/* Table Container */}
            <div className="relative bg-card/80 backdrop-blur-sm rounded-2xl border border-border/50 shadow-2xl overflow-hidden">
              {/* Table Header */}
              ...
              <div className="divide-y divide-border/30">
                  ...
                  return (
                    <div
                      key={user.id}
                      className={`group grid grid-cols-12 gap-4 p-5 items-center transition-all duration-300 
                        ${isTopThree ? 'bg-gradient-to-r from-muted/10 via-muted/5 to-transparent' : 'hover:bg-muted/10'}
                    ...
                    >
                      ...
                      <div className="col-span-1 lg:col-span-1 flex justify-center">
                        ...
                        `}>
                          ...
                          {rank <= 3 && (
                            <div className="absolute -inset-1 bg-gradient-to-r from-current to-transparent opacity-10 rounded-2xl blur-sm" />
                          )}
                        </div>
                      </div>
                        ...
                        <div className="flex items-center gap-4">
                          <div className="relative">
                            <UserAvatar 
                              ...
                              size="lg"
                              trigger="hover"
                              className={`transition-all duration-300 group-hover:ring-2 group-hover:ring-offset-2 group-hover:ring-offset-background
                                ${rank === 1 ? 'group-hover:ring-yellow-500' : 
                                  rank === 2 ? 'group-hover:ring-gray-400' : 
                                  rank === 3 ? 'group-hover:ring-orange-500' : 
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            >
                              <div className="flex items-center gap-2 group/user">
                                <span className="font-semibold text-base lg:text-lg truncate group-hover/user:text-primary transition-all duration-300">
                                  {user.name}
                                </span>
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div className="relative">
                            <div className="flex items-center gap-2.5 bg-gradient-to-r rounded-xl backdrop-blur-sm 
                                         px-4 py-2.5 
                                          ">
                              <ZapIcon className="w-5 h-5 text-amber-500 animate-pulse" />
                              <span className="text-2xl font-bold bg-gradient-to-r from-amber-600 to-yellow-600 bg-clip-text text-transparent">
                                {channelLevel}
                              </span>
                            </div>
                            {rank <=3 && (
                              <div className="absolute -inset-1 bg-gradient-to-r from-amber-500/20 via-yellow-500/20 to-amber-500/20 blur-xl rounded-xl" />
                            )}
                          </div>
                        </div>
                      </div>
