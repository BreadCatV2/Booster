...
export const VideoTopRow = ({ video, onRate,boostPoints}: Props) => {
    ...
    return (
        <div className="flex flex-col gap-3 mt-4">
            ...
            <div className="flex lg:items-start justify-between z-30 min-w-0 gap-y-2">
                <div className="min-w-0 overflow-hidden order-2 ">
                    <VideoOwner user={video.user} videoId={video.id} boostPoints={boostPoints} />
                </div>
                
                <div className="flex flex-row md:items-start justify-between sm:justify-end sm:min-w-[180px] gap-2 order-2">
                    <VideoReactions 
                        onRate={onRate} 
