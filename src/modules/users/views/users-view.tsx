...
import { UserVideoList, UserVideoCount } from "./user-videos";
...
export const UsersView = ({ userId }: Props) => {
  ...
  // userVideos query moved to child components
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="container mx-auto p-4">
            ...
            <div className="flex flex-col items-center md:items-center md:w-1/3 mb-6 md:mb-0 min-w-0">
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="flex flex-wrap gap-3 my-4 justify-center md:justify-start">
                  <Suspense fallback={
                    <div className="bg-muted/50 p-3 rounded-lg border border-border text-center min-w-[90px] transition-transform flex items-center justify-center">
                      <Spinner variant="circle" />
                    </div>
                  }>
                    <UserVideoCount userId={userId} />
                  </Suspense>
        ...
        {/* Video Grid */}
        {activeTab === "videos" && (
          <Suspense fallback={<div className="flex justify-center p-4"><Spinner variant="circle" /></div>}>
            <UserVideoList userId={userId} isOwnProfile={isOwnProfile} />
          </Suspense>
        )}
